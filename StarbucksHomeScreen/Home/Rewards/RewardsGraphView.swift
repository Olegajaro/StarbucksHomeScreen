...
class RewardsGraphView: UIView {
    ...
    func drawRewardsGraph() {
        ...
        /*
         Because Core Graphics straddles its frame when it draws, and we want a
         circle exactly at this point, we need to offset by this amount in the y.
         The 50 it just to push everything down enough to make room for the
         green indicator.
         */
