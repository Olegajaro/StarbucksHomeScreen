    ...
    private func layout() {
        ...
        NSLayoutConstraint.activate([
            starView.leadingAnchor.constraint(
                equalTo: pointsLabel.trailingAnchor, constant: -2
            ),
            starView.centerYAnchor.constraint(
                equalTo: pointsLabel.centerYAnchor, constant: 4
            ),
        ...
        NSLayoutConstraint.activate([
            starBalanceLabel.topAnchor.constraint(
                equalTo: pointsLabel.bottomAnchor, constant: 0
            ),
